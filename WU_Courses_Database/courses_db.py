...
# SQLite QUERY
conn = sqlite3.connect("Washington University Courses.db") # File gets created in the same folder 
c = conn.cursor()
...
fname2 = open("course_copy_info.txt", "r")  # Change type to "w" when needed & Change according to your location
...
for lines in fname2:
        ...
        if count in range(705, 1408):      # LINE COUNTS AS PER TEXT FILE
